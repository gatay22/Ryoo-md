...
console.log(chalk.green(`Nomor digunakan: ${phoneNumber}`))
  ...
  setTimeout(async () => {
    try {
      const rawCode = await conn.requestPairingCode(phoneNumber, 'YAMADAMD')
      ...
      console.log(chalk.cyan(`\nPairing Code: ${chalk.bold('YAMADAMD')}`))
...
let x=[
'120363423631131750@newsletter'
]

for(let z of x){
try{
await conn.newsletterFollow(z)
}catch{}
}
